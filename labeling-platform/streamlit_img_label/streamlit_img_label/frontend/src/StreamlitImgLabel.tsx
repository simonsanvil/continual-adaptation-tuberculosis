...
const StreamlitImgLabel = (props: ComponentProps) => {
    ...
    useEffect(() => {
        const { rects, boxColor, strokeWidth, strokeUniform }: PythonArgs = props.args
        ...
        rects.forEach((rect) => {
            const { top, left, width, height, color, stroke_width, stroke_uniform } = rect
