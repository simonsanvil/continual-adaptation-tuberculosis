...
logger = logging.getLogger('bacili_detection.detr.main')
...
def get_args_parser():
    ...
    parser.add_argument('--logging_file', default=None, type=str, help='path to file where to save logs')
    parser.add_argument('--logging_level', default=logging.INFO, type=int, help='logging level')
    parser.add_argument('--logging_format', default='%(asctime)s - %(name)s - %(levelname)s - %(message)s', type=str, help='logging format')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        coco_evaluator = None # TODO: remove this line
...
if __name__ == '__main__':
    ...
    if args.logging_file:
        Path(args.logging_file).parent.mkdir(parents=True, exist_ok=True)
        fh = logging.FileHandler(args.logging_file)
        if args.logging_level:
            fh.setLevel(args.logging_level)
        else:
            fh.setLevel(logging.INFO)
        if args.logging_format:
            formatter = logging.Formatter(args.logging_format)
