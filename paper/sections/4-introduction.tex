...
%  drug discovery and early detection of
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\textwidth]{figures/ERA4TB_map.png}
...
%    \clearpage
    ...
    On the other side, the design of such systems in practice presents unique challenges that must be addressed. Some experts argue that the questionable robustness of the adaptation process \cite{vokingerContinualLearningMedical2021} is onee of the reasons why \textbf{the FDA has never approved a medical application based on continual learning}.
