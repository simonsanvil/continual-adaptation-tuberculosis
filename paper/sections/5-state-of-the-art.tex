...
\begin{document}
    ...
    Similar works such as Gheibi et al. (2020) \cite{gheibiApplyingMachineLearning2020}, which makes a review of the literature on machine learning applied to self-adaptive systems, also focuses on the use of MAPE-K loops to develop such systems. Furthermore, the authors differentiate between two classes of problems that are tacked by ML in SAS: \textbf{adaptation problems where learning is applied} and \textbf{learning problems where adaptation is applied}.
